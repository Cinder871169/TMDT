  ...
  return (
    <aside className="w-full lg:w-80 flex-shrink-0">
      <div className="bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-gray-50 sticky top-6">
        ...
        {/* Filter Sections Container with Scrollbar */}
        <div className="max-h-[calc(100vh-300px)] overflow-y-auto pr-2 filter-scrollbar">
          {/* Brand Filter */}
          <div className="mb-8">
            <button
                  ...
                  {colors.map((color) => (
                    ...
                    >
                      <div
                        ...
                        style={{
                          backgroundColor: color.toLowerCase().includes("đen")
                            ? "#000"
                            : color.toLowerCase().includes("trắng")
                              ? "#fff"
                              : color.toLowerCase().includes("xanh navy")
                                ? "#1e3a8a"
                                : color.toLowerCase().includes("xanh")
                                  ? "#3b82f6"
                                  : color.toLowerCase().includes("đỏ")
                                    ? "#ef4444"
                                    : color.toLowerCase().includes("xám")
                                      ? "#6b7280"
                                      : "#f3f4f6",
                        }}
                      ></div>
