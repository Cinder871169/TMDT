                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-800">
                    {order.paymentMethod === "cod" ? "Thanh toán khi nhận hàng (COD)" : 
                     order.paymentMethod === "vietqr" ? "Quét mã QR (VietQR)" : "Chuyển khoản ngân hàng"}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">Tổng tiền</span>
                  <span className="font-bold text-lg text-orange-600">{order.totalPrice?.toLocaleString()}đ</span>
                </div>
              </div>
            </div>
          )}
          ...
          {order?.paymentMethod === "cod" && (
            <div className="p-6 bg-orange-50 border-b border-orange-100">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-orange-800 mb-2">Thanh toán khi nhận hàng (COD)</h3>
                  <ul className="text-sm text-orange-700 space-y-1">
                    <li>• Bạn sẽ thanh toán <strong>{order?.totalPrice?.toLocaleString()}đ</strong> khi nhận được hàng</li>
                    <li>• Nhân viên giao hàng sẽ liên hệ trước khi giao</li>
                    <li>• Vui lòng giữ điện thoại thông suốt để nhận hàng</li>
                  </ul>
                </div>
              </div>
            </div>
